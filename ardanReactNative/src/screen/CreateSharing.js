    ...
    <SafeAreaView style={[theme.bgblack,{flexGrow: 1},theme.pt10, theme.relative]}>
      <ScrollView style={[]}>
        <View style={[theme.px10,theme.pb100]}>
          ...
          <TextInput multiline={true} numberOfLines={3} style={[theme.wp100,theme.cwhite,theme['h14-400'],{textAlignVertical:'top'},theme.bbw2,theme.byellow,theme.bsolid]} placeholder="Title" placeholderTextColor={'#fff'} onChangeText={settitle} value={title}/>
